...
const services = [
  { title: "Medical Inquiry", copy: "Request appropriate medical-information support for a product or use-related question.", icon: Stethoscope, tone: "blue" as const },
    ...
    <PortalShell>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => (
              <article key={service.title} className="card-lift flex min-h-[248px] flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <button type="button" className="mt-auto inline-flex items-center gap-2 pt-5 text-sm font-bold text-blue-700 hover:text-blue-900">
      ...
      <section className="bg-slate-50 py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-7 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <div className="rounded-3xl bg-gradient-to-br from-blue-700 to-blue-950 p-8 text-white sm:p-10">
            ...
            <p className="mt-4 leading-7 text-blue-100">Medical, scientific, quality, and safety questions often follow different processes. Use this hub to identify the appropriate route before contacting your local support network.</p>
          </div>
