    ...
    <PortalShell>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8 lg:py-24">
          <div className="relative z-10">
            ...
            <h1 className="max-w-3xl text-5xl font-bold tracking-[-0.06em] text-slate-950 sm:text-6xl lg:text-7xl">
              Better <span className="text-blue-600">Day</span> Hub
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/counseling"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-200 transition hover:-translate-y-0.5 hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                Explore Resources <ArrowRight size={18} />
              </Link>
              <Link
                to="/product-evidence"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3.5 text-sm font-bold text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:text-blue-700"
              >
            ...
            <div className="mt-10 flex flex-wrap gap-x-7 gap-y-4 text-sm">
              ...
              <div className="flex items-center gap-2 text-slate-600"><span className="h-2 w-2 rounded-full bg-blue-500" /> Evidence &amp; safety focused</div>
          ...
          <div className="relative min-h-[390px]">
            <div className="absolute inset-6 rounded-[2rem] bg-gradient-to-br from-blue-600 via-blue-600 to-teal-500 shadow-2xl shadow-blue-200" />
            <div className="absolute inset-x-0 bottom-0 top-0 rounded-[2rem] border border-white/60 bg-white/10 backdrop-blur-[1px]" />
            <div className="absolute left-6 top-7 rounded-2xl border border-white/70 bg-white p-4 shadow-xl shadow-blue-950/10 sm:left-10">
              <div className="flex items-center gap-3">
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-blue-50 text-blue-600"><BookOpen size={22} /></span>
                <span>
            ...
            <div className="absolute right-4 top-28 w-56 rounded-2xl border border-white/80 bg-white p-5 shadow-xl shadow-blue-950/10 sm:right-8">
            ...
            <div className="absolute bottom-6 left-5 right-5 rounded-2xl border border-white/60 bg-slate-950 p-5 text-white shadow-xl shadow-blue-950/20 sm:bottom-9 sm:left-10 sm:right-10">
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          ...
          <div className="rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 to-teal-50 p-8 sm:p-10">
            <p className="text-xs font-bold uppercase tracking-[0.16em] text-blue-700">Safety-first framework</p>
            <div className="mt-5 space-y-4">
              {["Confirm relevant symptoms and timing", "Screen for key contraindications and duplicate NSAID use", "Refer promptly when red flags are present"].map((item, index) => (
                <div key={item} className="flex gap-3">
                  <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-white text-xs font-bold text-blue-700 shadow-sm">{index + 1}</span>
                  <p className="pt-0.5 text-sm font-semibold leading-6 text-slate-700">{item}</p>
                </div>
              ))}
            </div>
            <Link to="/safety" className="mt-7 inline-flex items-center gap-2 text-sm font-bold text-blue-700 hover:text-blue-900">
